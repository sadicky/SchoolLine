<?php
 ...
 $prof = new Prof();
 foreach ($data= $prof->getProfs() as $value) {
   echo "<tr><td><b><a href='#' id='$value->ID' title='$value->NOMS' data-toggle='popover' class='afficher'  > PROF000".$value->ID."</b></a></td>";
   ...
   echo "<td><b><a href='#' data-toggle='tooltip' data-placement='top'  >".$value->NATIONALITE."</b></a></td>";
   if($value->ACCESS == 0){
