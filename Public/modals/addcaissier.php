<!-- Modal -->
<div id="ajoutcais" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Ajouter un caissier</h4><hr>
        <b><i class="text-danger">Les informations suivies d'un asteriste sont obligatoires</i></b>
      </div>
      <div class="modal-body">
      <form method="post" id="formcais" enctype="multipart/form-data">
      	<div class="row">
      		<div class="col-sm-4">
      			<div class="form-group">      				
					  ...
					  ?>
					  <input type="text" class="form-control" value="<?php echo "C-".$titre?>" name="titre" id="titre" readonly>
      			</div>
      			<div class="form-group">      				
