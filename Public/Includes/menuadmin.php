  ...
  <div class="container-fluid">  
   ...
   <a href="index.php?page=accueilAdmin"><img src="public/images/logo.jpg" width="50px"></a>
    ...
    <ul class="nav navbar-nav">  
      <li class="active"><a href="index.php?page=accueilAdmin">Accueil</a></li>  
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Utilisateurs<span class="caret"></span></a>  
        <ul class="dropdown-menu">  
          <li><a href="index.php?page=affadmin">Admins</a></li>  
          <li><a href="index.php?page=affeleve">Elèves</a></li>  
          <li><a href="index.php?page=affencodeur">Encodeurs</a></li>  
          <li><a href="index.php?page=affchef">Chefs de Classe</a></li>  
          <li><a href="index.php?page=affcaissier">Caissier</a></li>  
          <li><a href="index.php?page=affprof">Professeurs</a></li>  
          <li><a href="index.php?page=affbibliotheq">Bibliothecaires</a></li>  
        </ul>  
      </li>   
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Caisse<span class="caret"></span></a>  
        <ul class="dropdown-menu">   
          ...
          <li><a href="index.php?page=cjour">Caisse Aujourd'hui</a></li>  
          <li><a href="index.php?page=cmois">Caisse Mois</a></li>  
          <li><a href="index.php?page=caa">Caisse AS</a></li>  
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Gestion<span class="caret"></span></a>  
        <ul class="dropdown-menu">  
          ...
          <li><a href="index.php?page=communique">Communiques</a></li> 
		  <li><a href="index.php?page=dette">Dette</a></li>  
