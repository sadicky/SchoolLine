...
-- Dumping data for table schoolline.classe: ~3 rows (approximately)
...
-- Dumping data for table schoolline.cours: ~7 rows (approximately)
...
-- Dumping data for table schoolline.profcours: ~9 rows (approximately)
