				...
				<table class="table table-condensed table-bordered table-striped" id="dataTables-example" style="margin-top:20px">
					...
					<tbody>
						...
						foreach ($getP as $value) {
							echo "<tr><td><b><a href='#' id='$value->ID' title='$value->NOMS' data-toggle='popover' class='afficher'  > " . $value->MATRICULE . "</b></a></td>";
							...
							echo "<td>
								 <button type='button' name='update' id='" . $value->ID . "' class='btn btn-block btn-xs btn-danger view_p'
