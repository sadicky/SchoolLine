<?php if (isset($_SESSION['logged'])) { ?>
	...
	<body>
		<div class="row" style="padding-top: 60px;margin: 8px;">
			...
			<div class="col-sm-10">
				<div class="well">
					<button type="button" data-toggle="modal" data-target="#ajoutenc" class="btn btn-primary btn-sm pull-right"><span class="glyphicon glyphicon-plus"></span> <b>Ajouter</b></button>
					<div class="panel-heading"><b><span class="glyphicon glyphicon-edit"></span> Les Encodeurs</b></div>
	...
	include_once 'Public/modals/addenc.php';
	include_once 'Public/modals/modenc.php';?>
	<script type="text/javascript" src="Public/ajax/encodeur.js"></script>
<?php } else {
