					...
					<table class="table table-condensed table-responsive table-striped" style="margin-top:20px">
						...
						<tr>
							...
							<td>
								...
								<a href="" data-toggle="modal" data-target="#Modifier" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-edit" data-toggle="tooltip" data-placement="top" title="Modifier" ></span></a>
